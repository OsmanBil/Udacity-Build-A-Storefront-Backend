...
var DashboardStore = /** @class */ (function () {
    ...
    DashboardStore.prototype.getOrderProducts = function (orderId) {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Could not get order products for order " + orderId + ": " + err_1);
    ...
    DashboardStore.prototype.getActiveOrdersByUser = function (userId) {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Could not get active orders for user " + userId + ": " + err_2);
                    case 4: return [2 /*return*/];
                }
            });
        });
